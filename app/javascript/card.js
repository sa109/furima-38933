const pay = () => {
  ...
  form.addEventListener("submit", (e) => {
    ...
    const card = {
      number: formData.get("purchase_shipping_adres[number]"),
      exp_month: formData.get("purchase_shipping_adres[exp_month]"),
      exp_year: `20${formData.get("purchase_shipping_adres[exp_year]")}`,
      cvc: formData.get(formData.get("purchase_shipping_adres[cvc]"),
    };
